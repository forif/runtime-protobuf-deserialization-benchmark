...
constexpr CrestMessage_HashEntry_DoNotUse::CrestMessage_HashEntry_DoNotUse(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized){}
struct CrestMessage_HashEntry_DoNotUseDefaultTypeInternal {
  constexpr CrestMessage_HashEntry_DoNotUseDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~CrestMessage_HashEntry_DoNotUseDefaultTypeInternal() {}
  union {
    CrestMessage_HashEntry_DoNotUse _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT CrestMessage_HashEntry_DoNotUseDefaultTypeInternal _CrestMessage_HashEntry_DoNotUse_default_instance_;
constexpr CrestMessage::CrestMessage(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : name_()
  , hash_(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{})
  , topm_(nullptr)
  , nestm_(nullptr)
  , id_(0)
  , fruit_(0)
...
struct CrestMessageDefaultTypeInternal {
  constexpr CrestMessageDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~CrestMessageDefaultTypeInternal() {}
  union {
    CrestMessage _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT CrestMessageDefaultTypeInternal _CrestMessage_default_instance_;
constexpr NestMessage::NestMessage(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : name_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , id_(0){}
struct NestMessageDefaultTypeInternal {
  constexpr NestMessageDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~NestMessageDefaultTypeInternal() {}
  union {
    NestMessage _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT NestMessageDefaultTypeInternal _NestMessage_default_instance_;
...
const char descriptor_table_protodef_crestmessage_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "STRAWBERRY\020\004\022\r\n\tCHOCOLATE\020\005\"\004\010\007\020\024B\t\n\007Pic"
  "kOne\"\'\n\013NestMessage\022\n\n\002id\030\001 \001(\005\022\014\n\004name\030"
  "\002 \001(\tb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_crestmessage_2eproto = {
  false, false, 453, descriptor_table_protodef_crestmessage_2eproto, "crestmessage.proto", 
  &descriptor_table_crestmessage_2eproto_once, descriptor_table_crestmessage_2eproto_deps, 1, 3,
  schemas, file_default_instances, TableStruct_crestmessage_2eproto::offsets,
  file_level_metadata_crestmessage_2eproto, file_level_enum_descriptors_crestmessage_2eproto, file_level_service_descriptors_crestmessage_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_crestmessage_2eproto_getter() {
  return &descriptor_table_crestmessage_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_crestmessage_2eproto(&descriptor_table_crestmessage_2eproto);
...
::PROTOBUF_NAMESPACE_ID::Metadata CrestMessage_HashEntry_DoNotUse::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_crestmessage_2eproto_getter, &descriptor_table_crestmessage_2eproto_once,
      file_level_metadata_crestmessage_2eproto[0]);
}
...
void CrestMessage::clear_topm() {
  if (GetArenaForAllocation() == nullptr && topm_ != nullptr) {
    delete topm_;
  }
  topm_ = nullptr;
}
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&topm_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&fruit_) -
...
void CrestMessage::ArenaDtor(void* object) {
  ...
  (void)_this;
  _this->hash_. ~MapField();
}
inline void CrestMessage::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena) {
  if (arena != nullptr) {
    arena->OwnCustomDestructor(this, &CrestMessage::ArenaDtor);
  }
}
...
::PROTOBUF_NAMESPACE_ID::Metadata CrestMessage::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_crestmessage_2eproto_getter, &descriptor_table_crestmessage_2eproto_once,
      file_level_metadata_crestmessage_2eproto[1]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata NestMessage::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_crestmessage_2eproto_getter, &descriptor_table_crestmessage_2eproto_once,
      file_level_metadata_crestmessage_2eproto[2]);
}
