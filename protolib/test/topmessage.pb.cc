...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_topmessage_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_topmessage_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_topmessage_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_topmessage_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_topmessage_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\020topmessage.proto\"D\n\nTopMessage\022\n\n\002id\030\001"
  " \001(\005\022\013\n\003val\030\002 \001(\001\022\014\n\004name\030\003 \001(\t\022\017\n\007check"
  "ed\030\004 \001(\010b\006proto3"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_topmessage_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_topmessage_2eproto = {
  false, false, 96, descriptor_table_protodef_topmessage_2eproto, "topmessage.proto", 
  &descriptor_table_topmessage_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_topmessage_2eproto::offsets,
  file_level_metadata_topmessage_2eproto, file_level_enum_descriptors_topmessage_2eproto, file_level_service_descriptors_topmessage_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_topmessage_2eproto_getter() {
  return &descriptor_table_topmessage_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_topmessage_2eproto(&descriptor_table_topmessage_2eproto);
...
::PROTOBUF_NAMESPACE_ID::Metadata TopMessage::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_topmessage_2eproto_getter, &descriptor_table_topmessage_2eproto_once,
      file_level_metadata_topmessage_2eproto[0]);
}
